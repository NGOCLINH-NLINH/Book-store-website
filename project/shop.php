...
$query = "SELECT address, phone FROM `users` WHERE user_id = '$user_id'";
...
<section class="products">
   ...
   <div class="box-container">
     ...
     <form action="" method="post" class="box">
      ...
      <input type="submit" value="add to cart" name="add_to_cart" class="btn" <?php if($disableAddToCartButton) echo 'onclick="alert(\'Please update your information!\'); return false;"'; ?>>
     </form>
      <?php
         }
      }else{
